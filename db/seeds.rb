...
Dose.create!([
  ...
  {description: "1/2 oz. (optional)", cocktail_id: 1, ingredient_id: 69},
  ...
  {description: "1 oz.", cocktail_id: 3, ingredient_id: 69},
  {description: "1/2 oz.", cocktail_id: 3, ingredient_id: 102},
